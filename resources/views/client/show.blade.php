                            ...
                            <div class="widget-body">
                                <form method="POST" action="{{url('client')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="phone"  readonly value="{{isset($user) && $user->status=='good' ? 'BUENO' : 'MALO'}}"  class="form-control {{isset($user) && $user->status=='good' ? 'text-success' : 'text-danger'}}" id="phone" required>
                                    </div>
                                </form>
