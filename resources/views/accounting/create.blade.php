...
@section('title', 'Nueva Entrada Contable')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nueva Entrada Contable</h3>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('accounting_account') is-invalid @enderror" 
                                           id="accounting_account" name="accounting_account" value="{{ old('accounting_account') }}">
